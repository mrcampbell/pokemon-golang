...
func (s *Species) GetGameIndex(versionGroup version.Version) int {
	for _, gameIndex := range s.GameIndices {
		if gameIndex.Version.Name == string(versionGroup) {
			return gameIndex.GameIndex
		}
	}
	return -1
}
